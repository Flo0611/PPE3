                 ...
                 <div style="width:90%;">
                     <table id="tableau" class="table table-striped table-bordered" style="width:100%">
                         ...
                         <tbody>
                           ...
                           <?php
                             $req = $un_contact->select_contact_non($conn);
                             while ($res = $req->fetch())
                             {
                               $nom = $res['nom_contact'];
                               ...
                               <tr>
                                 ...
                                 <td style="text-align:center"><input type="checkbox" name="<?php echo "lu_cocher".$id_contact; ?>" value="<?php echo $id_contact; ?>"></td>
                               </tr>
                               <?php
                             }
                           ?>
                         ...
                         <tfoot>
                             <tr>
                               ...
                               <th style="text-align:center"><button type="submit" name="lu_button" class="badge badge-pill badge-danger">Valider</button></th>
                             </tr>
                         </tfoot>
                     </table>
                   </div>
