...
require('../recaptcha/autoload.php');
 if(isset($_POST['inscription_button'])) {
   if(isset($_POST['g-recaptcha-response'])) {
     $recaptcha = new \ReCaptcha\ReCaptcha('6LeuQMgUAAAAAI2L7CsWJOUNqKpuoIQkvmUOuJFi');
     ...
     else
     {
         ...
         header("location:../public/inscription.php?erreur=captcha");
     }
   }
   else
   {
     header("location:../public/inscription.php?erreur=captcha_rempli");
   }
 }
