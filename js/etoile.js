...
//-------------------------------------------------------
// Envoie les données à la page de traitement (passage de la variable js en phppour traitement)
//-------------------------------------------------------
function envoiedonnee(id)
{
var xhr = new XMLHttpRequest();   // creation d’un objet et une requête HTTP est envoyée à l'adresse spécifiée

xhr.open("POST", "../traitement/note.trait.php", true);   // l’adresse spécifiée

xhr.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");   //dfinition du type de doc

xhr.send("nbetoile=" + escape(ArrListeEtoile[id]) + "&id_cheval=" + escape(id));  //transfert de la variable JS
